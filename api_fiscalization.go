...
func (r FiscalizationAPIGetFiscalDataRequest) Auth(auth string) FiscalizationAPIGetFiscalDataRequest {
	r.auth = &auth
	return r
}
...
func (r FiscalizationAPISubmitFiscalItemsRequest) Auth(auth string) FiscalizationAPISubmitFiscalItemsRequest {
	r.auth = &auth
	return r
}
...
func (r FiscalizationAPISubmitFiscalQRCodeRequest) Auth(auth string) FiscalizationAPISubmitFiscalQRCodeRequest {
	r.auth = &auth
	return r
}
