...
func (r CardAPICreateCardTokenRequest) Auth(auth string) CardAPICreateCardTokenRequest {
	r.auth = &auth
	return r
}
...
func (r CardAPIDeleteCardTokenRequest) Auth(auth string) CardAPIDeleteCardTokenRequest {
	r.auth = &auth
	return r
}
...
func (r CardAPIVerifyCardTokenRequest) Auth(auth string) CardAPIVerifyCardTokenRequest {
	r.auth = &auth
	return r
}
